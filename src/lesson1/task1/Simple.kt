 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = hoursArrive * 60 + minutesArrive - minutesDepart - hoursDepart * 60
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val part=(percent+100.0)/100
    return initial*part*part*part
}
